...
void publishTelemetry() {
  // check if the device is connected to the cloud or not
   if (!mqtt.connected()) return;

  // store the value as key value format
  ...
  // add load discision and throttle level and overloadActive to the telemetry data
  ...
  //push the data to cloud ,tpic, data->buffer
